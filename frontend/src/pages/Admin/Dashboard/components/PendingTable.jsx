...
export function PendingTable({ pendingRegistrations }) {
  const { updateRegistration } = useAdminStore()
  ...
  const handleReject = (id) => {
    // This would need a separate API endpoint for rejection
    alert(`Rejection functionality requires additional API endpoint`)
  }
